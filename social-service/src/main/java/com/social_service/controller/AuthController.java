...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<Object>> login(@Valid @RequestBody AuthRequest request) throws Exception {
    ...
    @Operation(
            ...
            description = "Trả về thông tin tài khoản đăng ký thành công"
    )
    ...
    @Operation(
            ...
            description = "Đặt lại mật khẩu cho tài khoản hợp lệ"
    )
    ...
    public ResponseEntity<ApiResponse<Object>> resetPassword(
        ...
        return ApiResponseUtil.buildSuccessResponse(
                HttpStatus.OK,
                Translator.toLocale(Message.USER_RESET_PASSWORD.getKey(), null),
                null
        );
    }

    @Operation(
            summary = "Đăng nhập tài khoàn goggle",
    ...
    public ResponseEntity<ApiResponse<Object>> getGoogleUrl() throws Exception {
        return ApiResponseUtil.buildSuccessResponse(
                HttpStatus.OK,
                Translator.toLocale(Message.SUCCESS.getKey(), null),
                authService.buildGoogleLoginUrl()
        );
    }

    @GetMapping("/public/google/call-back")
    @Operation(
